...
CREATE TABLE [IGP_MENU_TRANSACTIONS] (
    [Id] int NOT NULL IDENTITY,
    [RecordUserId] int NOT NULL,
    [RecordDate] date NOT NULL,
    [UpdateUserId] int NULL,
    ...
    CONSTRAINT [PK_IGP_MENU_TRANSACTIONS] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_IGP_MENU_TRANSACTIONS_IGP_MENU_MenuId] FOREIGN KEY ([MenuId]) REFERENCES [IGP_MENU] ([Id]) ON DELETE CASCADE
);
...
CREATE TABLE [IGP_USER_TRANSACTION_PERMISSIONS] (
    [Id] int NOT NULL IDENTITY,
    [RecordUserId] int NOT NULL,
    [RecordDate] date NOT NULL,
    [UpdateUserId] int NULL,
    ...
    CONSTRAINT [PK_IGP_USER_TRANSACTION_PERMISSIONS] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_IGP_USER_TRANSACTION_PERMISSIONS_IGP_MENU_TRANSACTIONS_TransactionId] FOREIGN KEY ([TransactionId]) REFERENCES [IGP_MENU_TRANSACTIONS] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_IGP_USER_TRANSACTION_PERMISSIONS_IGP_USER_UserId] FOREIGN KEY ([UserId]) REFERENCES [IGP_USER] ([Id]) ON DELETE CASCADE
);

GO

CREATE INDEX [IX_IGP_MENU_TRANSACTIONS_MenuId] ON [IGP_MENU_TRANSACTIONS] ([MenuId]);
...
CREATE INDEX [IX_IGP_USER_TRANSACTION_PERMISSIONS_TransactionId] ON [IGP_USER_TRANSACTION_PERMISSIONS] ([TransactionId]);

GO

CREATE INDEX [IX_IGP_USER_TRANSACTION_PERMISSIONS_UserId] ON [IGP_USER_TRANSACTION_PERMISSIONS] ([UserId]);

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20190805201216_mig1', N'2.2.6-servicing-10079');
